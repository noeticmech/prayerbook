...
\include{sections/prepare}
\include{sections/vespers}
\include{sections/compline}
\include{sections/midnight}
\include{sections/orthros}
\include{sections/prime}
\include{sections/terce}
\include{sections/sext}
\include{sections/none}
\include{sections/typika}
\include{sections/meals}
\include{sections/intercession}
\include{sections/litanies}
\include{sections/occasional}
\include{sections/favorites}
\include{sections/confession}
\include{sections/communionCanon}
\include{sections/communionPrayers}
\include{sections/departedAkathist}
\include{sections/paschal}
\include{sections/resurrection}
\include{sections/weekday}
\include{sections/feasts}
\include{sections/lectionary}
